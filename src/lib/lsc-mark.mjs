 ...
 *
 * Imported by BOTH src/components/LscMark.astro (at build time, from Astro
 * frontmatter) and scripts/build-brand-assets.mjs, so the on-page mark and every
 * generated raster are provably the same geometry. Mirrored verbatim in
 * litbible.net's repo — keep the two in step.
 */
